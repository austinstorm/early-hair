...
- In the *Create Client ID* modal dialog:
 ...
 - **Authorized Javascript origins**: https://project-name.gomix.me
 - **Authorized redirect URI**: https://project-name.gomix.me/auth/google/callback
...
- Select **Website**
- Enter `https://project-name.gomix.me` under *Site URL*
...
- For *Authorization Callback URL*: https://project-name.gomix.me/auth/github/callback
...
- For **Callback URL**: https://project-name.gomix.me/auth/twitter/callback
- Go to **Settings** tab
...
- Fill out all the *required* fields
 - **OAuth 2.0 Redirect URLs**: https://project-name.gomix.me/auth/linkedin/callback
 - **JavaScript API Domains**: https://project-name.gomix.me
...
- For **Redirect URI**: https://project-name.gomix.me/auth/foursquare/callback
- Click **Save Changes**
...
- For **Default Callback URL**: `https://project-name.gomix.me/auth/tumblr/callback`
- Click **✔Register**
...
Restart the server (if you are not using **nodemon**), then you should see the new template at [https://project-name.gomix.me/escape-velocity](https://project-name.gomix.me/escape-velocity).
